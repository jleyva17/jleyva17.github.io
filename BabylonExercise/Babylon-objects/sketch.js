      ...
      console.log(RPGCharacter.strength);
      console.log(RPGCharacter.intelligence);
      console.log(RPGCharacter.speed);
      console.log(RPGCharacter.charisma);
      console.log(RPGCharacter.luck);
