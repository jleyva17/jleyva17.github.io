...
let face = "front of person"; /*Between the quotation marks, 
...
let red = "emotion"; //repeat the instructions with the word "red" (keep in the form of a noun)

let brain = "thought center"; //repeat the instructions for the word "brain"

let masculine = "egotistical" //define 'masculine' in ADJECCTIVE form, so 
//you could sub it into a sentence that uses the word as an ADJECTIVE

let think = "process"; //define 'think' in VERB form,
